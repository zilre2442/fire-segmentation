...
FULL_DATASET_ZIPS_PATH = '/root/autodl-tmp/lcz_data' # where the continents zips are stored
FULL_DATASET_UNZIP_PATH = '/root/autodl-tmp/lcz_data/unziped' # where the continents zips will be unziped
