...
示例：
CUDA_VISIBLE_DEVICES=4,5 torchrun --nproc_per_node=2 --master_port=65530 exp/eval_scripts/eval_RGS_Net_V4.py --dist --data-root data/splits_activefire --algo voting --threshold 0.5 --save-dir output/RGS_Net_V4/voting_202601060937 --extra-output --cat-thresholds 10 100 1000 --samples-per-cat 5
CUDA_VISIBLE_DEVICES=4 python exp/eval_scripts/eval_RGS_Net_V4.py --data-root data/splits_activefire --algo voting --threshold 0.5 --save-dir output/RGS_Net_V4/voting_202512162140
"""
...
def parse_args():
    ...
    p.add_argument("--save-dir", type=str, default="output/RGS_Net_V4/voting_date", help="训练输出目录，用于推断权重路径和保存评估结果")
