...
CUDA_VISIBLE_DEVICES=4,5,7 torchrun --nproc_per_node=3 --master_port=65531 exp/train_scripts/train_RGS_Net_V4.py --data-root data/splits_activefire --algo voting
CUDA_VISIBLE_DEVICES=7 python exp/train_scripts/train_RGS_Net_V4.py --data-root data/splits_activefire --algo voting
"""
