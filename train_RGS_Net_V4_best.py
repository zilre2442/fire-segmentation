...
CUDA_VISIBLE_DEVICES=1,4,5,6,7 torchrun --nproc_per_node=5 --master_port=65530 train_RGS_Net_V4.py --data-root data/splits_activefire --algo voting --bands 7 6 5 --epochs 80 --batch-size 16 --lr 3e-4 --base-filters 64 --num-workers 4 --dist
"""
...
from loss import SpatialFocalTverskyLoss, FocalTverskyLoss, get_criterion_info
