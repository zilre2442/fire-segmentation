...
示例：
CUDA_VISIBLE_DEVICES=1,4,5,6,7 torchrun --nproc_per_node=5 --master_port=65530 eval_RGS_Net_V4.py --dist --data-root data/splits_activefire --algo voting --bands 7 6 5 --batch-size 16 --save-dir output/RGS_Net_V4/voting_202511261023
python eval_RGS_Net_V4.py --model-path output/RGS_Net_V4/voting_202511261023/weights/model_best.pth --algo voting --bands 7 6 5 --output-type fused --threshold 0.5 --save-dir output/RGS_Net_V4/voting_202511261023
"""
